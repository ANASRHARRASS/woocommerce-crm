<?php
/**
 * Plugin Name: Woo CRM (Kachkhat Saber)
 * Description: Enhanced WooCommerce CRM with WhatsApp integration, lead capture, dashboard analytics, and Elementor widgets.
 * Version: 0.2.0
 * Author: Your Name
 * License: GPL2
 * Requires PHP: 8.0
